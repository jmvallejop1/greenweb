...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="css/styleProfile_mal.css">
            ...
            <center>
               ...
               <table>
                  ...
                  <form action="/" method="post">
                     ...
                     <tr><td class="error">Usuario escogido incorrecto</td></tr>
                     <!-- Aquí se debe comprobar que el nombre de usuario esta libre -->
                     <tr class="data"><td>Correo electrónico: </td><td><input type="email"required placeholder="usuarioPrueba@gmail.com"></td></tr>
